...
def handle_follow(event):
    # 这里写你想要发送给新用户的文本
    welcome_text = 'こんにちは、私の名前はローチャンロン、24歳、マレーシア出身で、日本大学から卒業しました。今回は面接のチャンスを頂き、誠にありがとうございます。2023年、私は新人として一つの会社に参加しました。私の仕事スタイルは、「分析、整理、提案を出す」というものです。これは問題をより広範囲かつ深く理解し、解決するためのアプローチだと信じています。また、私は常に他人を助け、学んだことを共有することを楽しむ楽観主義者です。しかし、現在私は新たな機会を探しています。現在の会社にはいくらか失望しているものの、私の仕事への情熱は健在で、この経験は私の職業生涯にとって貴重な教訓だと考えています。私の能力を十分に発揮し、私の価値観に適合する新たな環境を探しています。余暇には、人と交流を持ち、新しい知識を学ぶのが好きです。人生における学習は終わりがないと思っていますし、新しい仕事で続けて成長し、学習したいと考えています。以上が私の自己紹介です。他にも知りたいことがありましたら、詳しくお答えしますのでお気軽にどうぞ。'
